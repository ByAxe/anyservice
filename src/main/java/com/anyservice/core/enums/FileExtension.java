...
public enum FileExtension {
    ...
    public static FileExtension findExtension(String contentType) {
        for (FileExtension extension : FileExtension.values()) {
            if (extension.getContentType().equalsIgnoreCase(contentType)) return extension;
        }
        return UNKNOW;
    }

    public static FileExtension findExtensionByName(String name) {
        for (FileExtension extension : FileExtension.values()) {
